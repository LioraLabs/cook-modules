-- cook_cc.toolchain — compiler selection: registers the cc:compiler:<override> probe, holds standard/warnings/default-flag state
-- domain:  toolchain — pure resolution: which compiler, identity, flag dialects
-- effects: cook.probe
-- std:     §12.7
local M = {}
