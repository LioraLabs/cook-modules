-- cook_cc.discovery.finders.bare_probe — registers the cc:linker-search-dirs probe and checks default linker paths for lib<name>.{so,dylib,a}
...
-- explicitly from `cook_cc.discovery.finder.register_find_probe` during register.
