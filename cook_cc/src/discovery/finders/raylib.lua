-- cook_cc.discovery.finders.raylib — curated raylib finder: pkg-config, then bare probe with raylib.h version sniff; macos frameworks appended
...
function M.find(opts)
    ...
    if b then
        ...
        local header = require("cook_cc.discovery.finders.header_probe")
