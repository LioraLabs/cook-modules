-- cook_cc.discovery._check_helpers — shared cc:check:<kind>:<name>:<short-fp> probe-body helpers: fingerprint, probe C source, compile command, result evaluation
-- domain:  discovery — registers probes (dependency finders, feature checks); facts in, no work units
-- effects: pure
--
-- Required by both register-phase (cook_cc.discovery.checks) and execute-phase
